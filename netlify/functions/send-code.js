...
<table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;background:linear-gradient(160deg,#0d0d14,#050508);border:1px solid rgba(200,160,80,0.2);border-radius:24px;overflow:hidden;">
  ...
  <tr><td align="center" style="padding:10px 40px 28px;">
  ...
  <tr><td style="padding:0 32px 12px;">
    <table width="100%" cellpadding="0" cellspacing="0" style="background:rgba(255,255,255,0.03);border:1px solid rgba(200,160,80,0.15);border-radius:16px;">
      <tr><td style="padding:20px 24px;">
        ...
        <p style="margin:0 0 6px;font-size:13px;color:rgba(245,240,232,0.7);line-height:1.7;"><span style="color:#e8c87a;font-weight:700;">1.</span>&nbsp; Appuie sur le bouton Partager ⬆️</p>
        <p style="margin:0 0 6px;font-size:13px;color:rgba(245,240,232,0.7);line-height:1.7;"><span style="color:#e8c87a;font-weight:700;">2.</span>&nbsp; Sélectionne <strong style="color:#fff;">"Sur l'écran d'accueil"</strong></p>
  ...
  <tr><td style="padding:0 32px 12px;">
    <table width="100%" cellpadding="0" cellspacing="0" style="background:rgba(255,255,255,0.03);border:1px solid rgba(200,160,80,0.15);border-radius:16px;">
      <tr><td style="padding:20px 24px;">
        ...
        <p style="margin:0 0 6px;font-size:13px;color:rgba(245,240,232,0.7);line-height:1.7;"><span style="color:#e8c87a;font-weight:700;">1.</span>&nbsp; Appuie sur les 3 points ⋮</p>
        <p style="margin:0 0 6px;font-size:13px;color:rgba(245,240,232,0.7);line-height:1.7;"><span style="color:#e8c87a;font-weight:700;">2.</span>&nbsp; Sélectionne <strong style="color:#fff;">"Ajouter à l'écran d'accueil"</strong></p>
        <p style="margin:0;font-size:13px;color:rgba(245,240,232,0.7);line-height:1.7;"><span style="color:#e8c87a;font-weight:700;">3.</span>&nbsp; Appuie sur <strong style="color:#fff;">"Ajouter"</strong> ✓</p>
      </td></tr>
    </table>
  </td></tr>
